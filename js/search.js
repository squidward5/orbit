document.addEventListener("DOMContentLoaded", () => {
    const searchInput = document.getElementById("searchbox") || document.getElementById("search-bar");
    ...
    const performSearch = (rawQuery, isInitialLoad = false) => {
        ...
        const targetUrl = `browse.html?q=${encryptedValue}`;
    ...
    document.getElementById("refresh")?.addEventListener("click", () => { if (searchFrame) searchFrame.src = searchFrame.src; });
    document.getElementById("home")?.addEventListener("click", () => { window.location.href = "index.html"; });
    document.getElementById("fullscreen")?.addEventListener("click", () => { if (searchFrame) searchFrame.requestFullscreen(); });
